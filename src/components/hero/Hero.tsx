  ...
  return (
    ...
    >
      <div className="flex flex-row text-4xl gap-3 font-space">
        ...
        <div
          className={`duration-3000 ease-linear text-shadow-lg animate-scalePulse text-balance
      ...
      <div
        className={`font-space duration-3000 ease-linear text-balance
            ...
            ${mode === "light" ? "text-[#A87777] text-shadow-black/40" : "text-[#60A5FA] text-shadow-white/40"} 
            `}
      >
        <TypeAnimation
